...
class PhoneNumberKitTests: XCTestCase {
    ...
    func testInvalidNumberE() {
        do {
            let phoneNumber = try phoneNumberKit.parse(rawNumber: "202 00e 0000", region: "US")
...
//    }
    ...
    func testInvalidESNumbers() {
        do {
            ...
            let phoneNumber = try phoneNumberKit.parse(rawNumber: "+34312431110")
            print(phoneNumber.toE164())
            XCTFail()
        }
        catch {
    ...
    func testItalianLeadingZero() {
        ...
        do {
            let phoneNumber = try phoneNumberKit.parse(rawNumber: testNumber)
//            XCTAssertEqual(phoneNumber.toInternational(), testNumber)
    ...
    func testGetRegionCode() {
        guard let phoneNumber = try? phoneNumberKit.parse(rawNumber: "+39 3123456789") else {
            XCTFail()
            return
        }
    ...
    func testGetRegionCodeLeadingDigits() {
        guard let phoneNumber = try? phoneNumberKit.parse(rawNumber: "876-123-4567") else {
            XCTFail()
            return
        }
