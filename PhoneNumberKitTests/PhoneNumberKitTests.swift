...
class PhoneNumberKitTests: XCTestCase {
    ...
    func testInvalidNumberE() {
        do {
            let phoneNumber = try phoneNumberKit.parse(number: "202 00e 0000", withRegion: "US")
...
//        do {
//            let phoneNumber = try phoneNumberKit.parse(number: "+16307792428", region: "US")
//            print(phoneNumber.toE164())
...
//            let phoneNumber = try phoneNumberKit.parse(number: "+44629996885")
//            print(phoneNumber.toE164())
...
//            let phoneNumber = try phoneNumberKit.parse(number: "+32910853865")
//            print(phoneNumber.toE164())
//            (phoneNumber.isValidNumber == true) ? XCTFail() : XCTAssert(true)
//        }
//        catch {
...
//            let phoneNumber = try phoneNumberKit.parse(number: "+21373344376")
//            print(phoneNumber.toE164())
//            XCTFail()
//        }
//        catch {
...
//            let phoneNumber = try phoneNumberKit.parse(number: "+861500376135")
//            print(phoneNumber.toE164())
//            (phoneNumber.isValidNumber == true) ? XCTFail() : XCTAssert(true)
//        }
//        catch {
...
//            let phoneNumber = try phoneNumberKit.parse(number: "+390762613915")
//            print(phoneNumber.toE164())
//            (phoneNumber.isValidNumber == true) ? XCTFail() : XCTAssert(true)
//        }
//        catch {
...
//    }
    ...
    func testInvalidESNumbers() {
        do {
            ...
            let phoneNumber = try phoneNumberKit.parse(number: "+34312431110")
            print(phoneNumber.toE164())
            XCTFail()
        }
        catch {
    ...
    func testItalianLeadingZero() {
        ...
        do {
            let phoneNumber = try phoneNumberKit.parse(number: testNumber)
//            XCTAssertEqual(phoneNumber.toInternational(), testNumber)
    ...
    func testGetRegionCode() {
        guard let phoneNumber = try? phoneNumberKit.parse(number: "+39 3123456789") else {
            XCTFail()
            return
        }
    ...
    func testGetRegionCodeLeadingDigits() {
        guard let phoneNumber = try? phoneNumberKit.parse(number: "876-123-4567") else {
            XCTFail()
            return
        }
