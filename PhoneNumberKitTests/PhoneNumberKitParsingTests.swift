...
class PhoneNumberKitParsingTests: XCTestCase {
    ...
    func testUSNumber() {
        do {
            ...
            XCTAssertNotNil(phoneNumber1)
            let phoneNumberInternationalFormat1 = phoneNumberKit.format(phoneNumber1, toFormat: .international)
            XCTAssertTrue(phoneNumberInternationalFormat1 == "+1 650-253-0000")
            let phoneNumberNationalFormat1 = phoneNumberKit.format(phoneNumber1, toFormat: .national)
            XCTAssertTrue(phoneNumberNationalFormat1 == "(650) 253-0000")
            let phoneNumberE164Format1 = phoneNumberKit.format(phoneNumber1, toFormat: .e164)
            ...
            let phoneNumberInternationalFormat2 = phoneNumberKit.format(phoneNumber2, toFormat: .international)
            XCTAssertTrue(phoneNumberInternationalFormat2 == "+1 800-253-0000")
            let phoneNumberNationalFormat2 = phoneNumberKit.format(phoneNumber2, toFormat: .national)
            XCTAssertTrue(phoneNumberNationalFormat2 == "(800) 253-0000")
            let phoneNumberE164Format2 = phoneNumberKit.format(phoneNumber2, toFormat: .e164)
            ...
            let phoneNumberInternationalFormat3 = phoneNumberKit.format(phoneNumber3, toFormat: .international)
            XCTAssertTrue(phoneNumberInternationalFormat3 == "+1 900-253-0000")
            let phoneNumberNationalFormat3 = phoneNumberKit.format(phoneNumber3, toFormat: .national)
            XCTAssertTrue(phoneNumberNationalFormat3 == "(900) 253-0000")
            let phoneNumberE164Format3 = phoneNumberKit.format(phoneNumber3, toFormat: .e164)
