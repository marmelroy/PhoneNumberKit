...
class PhoneNumberKitParsingTests: XCTestCase {
    ...
    func testUSNumber() {
        do {
            ...
            XCTAssertNotNil(phoneNumber1)
            let phoneNumberInternationalFormat = phoneNumber1.toInternational()
            XCTAssertTrue(phoneNumberInternationalFormat == "+1 650-253-0000")
            let phoneNumberNationalFormat = phoneNumber1.toNational()
            XCTAssertTrue(phoneNumberNationalFormat == "(650) 253-0000")
