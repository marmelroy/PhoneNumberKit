...
2. In the next page, specify the version resolving rule as "Up to Next Major" with "3.3.2".
...
```swift
dependencies: [
    .package(url: "https://github.com/marmelroy/PhoneNumberKit", .upToNextMajor(from: "3.3.2"))
]
```
